...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    socials: Attribute.Component<'ui.social', true> &
      Attribute.SetMinMax<
        {
          max: 2;
        },
...
export interface ApiIntegrationIntegration extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    list: Attribute.Component<'ui.benefit', true>;
    slug: Attribute.UID<'api::integration.integration', 'name'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSolutionSolution extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::solution.solution', 'title'> & Attribute.Required;
    suptitle: Attribute.String & Attribute.Required;
    short_text: Attribute.Text & Attribute.Required;
    steps: Attribute.Component<'ui.step', true> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSolutionPageSolutionPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    suptitle: Attribute.String & Attribute.Required;
    text: Attribute.Text & Attribute.Required;
    review: Attribute.Component<'ui.review'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
